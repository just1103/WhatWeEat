...
- [1️⃣ STEP1. `Onboarding` 화면 구현](#STEP1.-`Onboarding`-화면-구현)
    ...
    + [키워드](#1-3-키워드)
- [2️⃣ STEP2. Tab Bar의 `Home` 화면 및 `설정` 화면 구현](#STEP2.-Tab-Bar의-`Home`-화면-및-`설정`-화면-구현)
    + [고민한 점](#2-1-고민한-점)
    + [Trouble Shooting](#2-2-Trouble-Shooting)
    + [키워드](#2-3-키워드)
- [3️⃣ STEP3. `미니게임` 화면 및 애니메이션 구현](#STEP3.-`미니게임`-화면-및-애니메이션-구현)
    + [고민한 점](#3-1-고민한-점) 
    + [Trouble Shooting](#3-2-Trouble-Shooting)
    + [키워드](#3-3-키워드)
- [4️⃣ STEP4. `미니게임 결과` 화면 구현 및 리팩토링](#STEP4.-`미니게임-결과`-화면-구현-및-리팩토링)
    + [고민한 점](#4-1-고민한-점) 
